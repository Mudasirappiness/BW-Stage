...
class Test_create_announce_project:

    def test_announce_project(self,caplog):
        """"Clicking on the Announce New Project button"""
        with caplog.at_level(logging.INFO):

            try:

                logging.info("Clicking on the Announce New Project button")
                announce_project = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "(//button[text()='Announce New Project'])[1]")))
                announce_project.click()
                time.sleep(3)

                logging.info("Successfully Clicked on the Announce New Project Button- Testcase 1.1 is passed")
        ...
        with caplog.at_level(logging.INFO):
            ...
            try:
                ...
                announce_project_location = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "//div[contains(@class,'relative')]//div[contains(@class,'w-full relative')]//input[contains(@type,'text')]")))
                ...
                logging.info("Successfully entered value in the location field- Testcase 1.2 is passed")
        ...
        with caplog.at_level(logging.INFO):
            ...
            try:
                ...
                logging.info("Successfully entered value in the Types of construction dropdown- Testcase 1.3 is passed")

            except (NoSuchElementException, ElementNotInteractableException) as e:

                logging.error("Element not found:{e}")

        """"Entering value in the Buildup field"""
        with caplog.at_level(logging.INFO):

            try:

                logging.info("Entering value in the buildup field")
                build_up_area = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "//input[@id='built-up-area']")))
                build_up_area.send_keys("8500")
                time.sleep(2)

                logging.info("Successfully Entered value in the buildup field- Testcase 1.4 is passed")

            except (NoSuchElementException, ElementNotInteractableException) as e:

                logging.error("Element not found:{e}")

        """"Clicking on the project estimate dropdown"""
        with caplog.at_level(logging.INFO):

            try:
                logging.info("Clicking on the project estimate dropdown")
                project_estimate = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "//*[@id='react-select-4-placeholder']")))
                project_estimate.click()
                time.sleep(3)

                project_estimate_suggestion = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "//p[@title='Less than 100 crore']")))
                project_estimate_suggestion.click()

                logging.info("Successfully entered value in the project estimate dropdown- Testcase 1.5 is passed")
        ...
        with caplog.at_level(logging.INFO):
            ...
            try:
                ...
                time_line = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "//*[@id='html']/body/main/div/div[5]/div/div[2]/div/div/div[6]/div/div/div/div")))
                time_line.click()
                time.sleep(3)

                time_line_suggestion = WebDriverWait(self.driver, 10).until(BD.element_to_be_clickable(
                    (By.XPATH, "//p[text()='Three Months']")))
                time_line_suggestion.click()
                logging.info("Successfully entered value in the project timeline button - Testcase 1.6 is passed")
        ...
        with caplog.at_level(logging.INFO):
            try:
                ...
                logging.info("Successfully Clicked on the upload button - Testcase 1.7 is passed")
        ...
        with caplog.at_level(logging.INFO):
            try:
                ...
                time.sleep(3)
                logging.info("Successfully entered value - Testcase 1.8 is passed")
        ...
        with caplog.at_level(logging.INFO):
            ...
            try:
                ...
                logging.info("Successfully Entered values in the description field - Testcase 1.9 is passed")
        ...
        with caplog.at_level(logging.INFO):
            ...
            try:
                ...
                logging.info("Successfully Clicked on the submit Button- Testcase 1.10 is passed")
        ...
        with caplog.at_level(logging.INFO):
            try:
                ...
                screenshot_path = os.path.join(folder_path, "announce_project.png")
