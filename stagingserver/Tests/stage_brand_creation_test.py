    ...
    def test_service_account(self, caplog, setup):
        ...
        with caplog.at_level(logging.INFO):
            try:
                ...
                send_keys(self.driver, class_Locators.sign_up_email_field, "dummybrand09@yopmail.com")
                time.sleep(2)
                ...
                click_action(self.driver, class_Locators.Brand_user_selection)
                click_action(self.driver, class_Locators.continue_button)
                time.sleep(2)
                ...
                send_keys(self.driver, class_Locators.brand_parent_company, "Mudasir@co")
                time.sleep(1)
                logging.info("Successfully name entered in the filed - Testcase 1.9 is passed")

                logging.info("Entering phone number")
                send_keys(self.driver, class_Locators.brand_phone_number, "9928948052")
                ...
                send_keys(self.driver, class_Locators.brand_city, "salem")
                time.sleep(1)
                click_action(self.driver, class_Locators.brand_city_suggestion)
                time.sleep(1)
                logging.info("Successfully selected - Testcase 1.13 is passed ")

                logging.info("Selecting a location served")
                send_keys(self.driver, class_Locators.brand_location_served, "Chennai")
                time.sleep(1)
                click_action(self.driver, class_Locators.brand_location_served_suggestion)
                time.sleep(1)
                logging.info("Successfully selected - Testcase 1.13 is passed ")
                ...
                click_action(self.driver, class_Locators.brand_id_type_selection)
                ...
                click_action(self.driver, class_Locators.brand_document_verify_button)
                time.sleep(10)
